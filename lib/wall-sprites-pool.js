...
WallSpritesPool.prototype.createFrontEdges = function () {
    ...
    this.addFrontEdgeSprites(2, Textures.WALL.EDGES[0]);
    this.addFrontEdgeSprites(2, Textures.WALL.EDGES[1]);
...
WallSpritesPool.prototype.createBackEdges = function () {
    ...
    this.addBackEdgeSprites(2, Textures.WALL.EDGES[0]);
    this.addBackEdgeSprites(2, Textures.WALL.EDGES[1]);
...
WallSpritesPool.prototype.createDecorations = function () {
    ...
    this.addDecorationSprites(6, Textures.WALL.DECORATIONS[0]);
    this.addDecorationSprites(6, Textures.WALL.DECORATIONS[1]);
    this.addDecorationSprites(6, Textures.WALL.DECORATIONS[2]);
...
WallSpritesPool.prototype.createWindows = function () {
    ...
    this.addWindowSprites(6, Textures.WALL.WINDOWS[0]);
    this.addWindowSprites(6, Textures.WALL.WINDOWS[1]);
